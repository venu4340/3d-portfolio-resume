...
const projects: Project[] = [
  {
    ...
    description:
      'Developed an application that explains programming code in simple language. Provides explanations of code logic, errors, and improvements. Designed the project to help beginners understand programming concepts.',
    githubUrl: 'https://github.com/venu4340/codeai',
    tech: [
      'Python',
      'AI / ML',
      'NLP',
    ...
    metrics: [
      { label: 'CORE STACK', value: 'Python, AI/ML, NLP' },
      { label: 'CAPABILITY', value: 'Logic & Error Insights' },
      { label: 'OBJECTIVE', value: 'Beginner Code Learning' },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Featured intelligent application architecture designed to convert code logic into clear, beginner-friendly explanations.
          </p>
        </motion.div>
