      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full px-6 sm:px-12 lg:px-16 pt-6 pb-8 pointer-events-none">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-[38rem] xl:max-w-[42rem] pointer-events-auto z-20"
          >
            ...
            <motion.div variants={fadeUpVariants} className="relative mb-3.5 select-none">
              ...
              >
                {/* Line 1: E. VENUMADHAV */}
                <span className="block text-transparent bg-clip-text bg-gradient-to-b from-[#FFFFFF] via-[#E8DFD8] to-[#605448] drop-shadow-[0_4px_12px_rgba(0,0,0,0.85)]">
                  E. VENUMADHAV
                </span>

                {/* Line 2: AI & SOFTWARE */}
                <span className="block text-transparent bg-clip-text bg-gradient-to-b from-[#F7E7C4] via-[#C99E5D] to-[#543B1A] drop-shadow-[0_8px_25px_rgba(201,158,93,0.35)] text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] mt-1 tracking-wider">
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                className="text-[11px] sm:text-xs md:text-[13px] font-medium tracking-[0.25em] uppercase text-[#E0D3C5]"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                B.Tech – Artificial Intelligence <span className="text-[#8C6D4F] mx-1">•</span> 3rd Year
              </p>
            </motion.div>
            ...
            >
              <p>
                Motivated Artificial Intelligence student with a strong interest in software development, AI, and problem-solving.
                <br />
                Seeking an internship or entry-level opportunity to apply technical skills and contribute to real-world projects.
              </p>
            </motion.div>
