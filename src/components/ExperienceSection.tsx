...
const journey: RouteStop[] = [
  {
    ...
    organization: 'SRI VENKATESA PERUMAL COLLEGE OF ENGINEERING',
    description: 'Pursuing 3rd Year B.Tech in Artificial Intelligence. Focusing on AI/ML foundations, Data Structures, and Software Development practices.',
  },
  {
    id: '02',
    year: 'CERTIFICATION',
    title: 'SQL BASIC CERTIFIED',
    organization: 'HACKERRANK',
    description: 'Certified in fundamental relational database concepts, SQL queries, data manipulation, filtering, and relational schema management.',
  },
  {
    id: '03',
    year: 'CERTIFICATION',
    ...
    organization: 'UDEMY',
    description: 'Completed in-depth training covering core Python programming, computational logic, object-oriented concepts, and error handling.',
  },
  {
    id: '04',
    year: 'CORE INTERESTS',
    title: 'AI & SOFTWARE ENGINEERING',
    organization: 'TECHNICAL FOCUS & LEARNING',
    description: 'Dedicated focus on Artificial Intelligence, Software Development, Machine Learning, and continuous exploration of emerging technologies.',
  },
];
